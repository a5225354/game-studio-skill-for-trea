...
**最后验证：** 2026-02-13
**知识缺口：** UE 5.7 新增 Megalights、生产就绪的 Substrate 和 Lumen 改进
...
UE 5.7 渲染栈：
- **Lumen**：实时全局光照 (Global Illumination)（默认）
- **Nanite**：百万级三角形的虚拟化几何体
- **Megalights**：支持百万级动态光源（5.5+ 新增）
