# Game Studio Skill Testing Framework

Quality assurance infrastructure for the **Trae Game Studio** Skill.
Tests the skills and agents themselves — not any game built with them.

> **This folder is self-contained and optional.**
> Game developers using the Game Studio Skill don't need it. To remove it entirely:
> delete this directory — nothing in the main project depends on it.
...
│   ├── review/            ← review category specs (含 Phase 9-13 审查报告)
...
```
delete the `docs/testing-framework/` directory
```
